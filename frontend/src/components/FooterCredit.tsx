  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-2 text-center">
        <div
          dir="ltr"
          className="flex items-center justify-center gap-1.5 text-zinc-500/80 dark:text-zinc-600/80 text-center text-[10px] font-bold tracking-wide"
        >
