  ...
  en: {
    ...
    steps: {
      ...
      advancedModes: {
        ...
        points: [
          "Image Steganography : Embed secret text payloads invisibly inside standard PNG images. The resulting image looks and opens like a normal photograph while concealing encrypted bitstreams in pixel color channels.",
