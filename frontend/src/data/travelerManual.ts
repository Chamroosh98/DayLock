...
export const travelerManual: Record<'en' | 'fa', LanguageManual> = {
  en: {
    title: "DayLock Security & Operations Manual",
  ...
  fa: {
    title: "راهنمای امنیت و کار با دی‌لاک (DayLock)",
  
    subtitle:
      "راهنمای ساده برای رمزگذاری، پنهان‌سازی و پاک‌سازی امن داده‌های حساس",
  
    startTourBtn: "شروع راهنما",
    closeBtn: "بستن راهنما",
  
    tabs: {
      overview: "۰. آشنایی با دی‌لاک",
    ...
    overviewHeading:
      "ساختار رمزگذاری بدون دسترسی سرور (Zero-Knowledge)",
  
    overviewText:
      "دی‌لاک (DayLock) یک گاوصندوق دیجیتالی امنه که برای نگهداری نوشته‌ها، پرونده‌ها و داده‌های حساس ساخته شده. تمام کارهای رمزگذاری و باز کردن رمز، روی خود دستگاه تو و داخل مرورگر انجام میشه. سرور فقط یک نسخه‌ی قفل‌شده از داده‌ها رو نگه می‌داره و هیچ راهی برای دیدن نوشته‌ها یا پیدا کردن کلید رمز تو نداره.",
    ...
    overviewCards: [
  ...
  
      {
        ...
        description:
          "دی‌لاک طوری ساخته شده که داده‌های حساس تا جای ممکن روی دستگاه باقی نمونه. نوشته‌های یک‌بارمصرف بعد از باز شدن پاک میشن و ابزارهای اضطراری می‌تونن داده‌های باز شده در مرورگر و حافظه دستگاه رو سریع پاک کنن."
      },
  
      {
        ...
        description:
          "اگر کسی تو رو مجبور کرد دی‌لاک رو باز کنی، می‌تونی از رمز پوششی استفاده کنی. این رمز فقط نوشته‌های معمولی و بی‌خطر رو نشون میده و راز اصلی همچنان پنهان می‌مونه."
      },
  
      {
        ...
        description:
          "می‌تونی مشخص کنی چه کشورها یا نشانی‌های اینترنتی اجازه باز کردن پیوند رو داشته باشن. اگر ربات یا فرد ناشناسی تلاش کنه وارد بشه، دی‌لاک می‌تونه بهت هشدار بده و واکنش از پیش تعیین‌شده انجام بده."
      }
    ],
    ...
    warningText:
      "هشدار امنیتی: اگر رمز اصلی دی‌لاک رو فراموش کنی، هیچ راهی برای بازگرداندن داده‌های رمزگذاری‌شده وجود نداره. این سیستم هیچ درِ پشتی (Backdoor) یا راه میانبری برای بازیابی رمز نداره.",
    ...
    steps: {
      ...
      coreModes: {
        ...
        description:
          "دی‌لاک بهت اجازه میده نوشته‌ها، یادداشت‌ها و پرونده‌های حساس رو مستقیم روی دستگاه خودت رمزگذاری کنی. همه‌چیز قبل از فرستادن قفل میشه و سرور فقط نسخه‌ی رمز شده رو نگه می‌داره.",
  
  
        points: [
  
          "گاوصندوق نوشته‌ها: از بخش «نوشته» برای نگهداری یادداشت‌ها، گذرواژه‌ها، گزارش‌ها یا هر نوشته‌ی حساسی استفاده کن. شکل و قالب نوشته هنگام رمزگذاری حفظ میشه.",
  
          "رمزگذاری پرونده و عکس: از بخش «پرونده» یا «عکس» برای امن کردن فایل‌ها استفاده کن. فایل‌ها قبل از فرستادن، تکه‌تکه داخل حافظه دستگاه رمزگذاری میشن.",
  
          "باز کن و تمام! (Burn-on-Read): برای نوشته‌های خیلی حساس این گزینه رو روشن کن. پس از یک‌بار باز شدن پیوند، داده به‌صورت خودکار پاک میشه.",
  
          "قفل با رمز اصلی: یک رمز قوی انتخاب کن. دی‌لاک از روی این رمز، کلید رمزگذاری قدرتمند می‌سازه. این رمز رو از دست نده چون راه برگشتی وجود نداره.",
      ...
      advancedModes: {
        ...
        description:
          "گاهی حتی یک پیوند رمزگذاری‌شده هم ممکنه جلب توجه کنه. دی‌لاک ابزارهایی داره که کمک می‌کنن داده‌های حساس رو بهتر پنهان کنی و ارتباط امن‌تری داشته باشی.",
        ...
        points: [
          ...
          "تقسیم راز شامیر (Shamir Secret Sharing): رمز اصلی رو به چند بخش ریاضی تقسیم کن. برای نمونه می‌تونی یک راز رو به ۵ بخش تقسیم کنی و تعیین کنی که برای بازسازی آن، داشتن ۳ بخش کافی باشه.",
        ...
        tip:
          "نکته پنهان‌سازی: هنگام فرستادن تصویر دارای داده مخفی، آن را به شکل «پرونده» بفرست، نه تصویر معمولی؛ چون فشرده‌سازی پیام‌رسان‌ها ممکنه داده پنهان رو خراب کنه."
      },
  
  
      evasion: {
  
        title: "مقابله با اجبار و رمز پوششی",
  
        badge: "پنهان ماندن راز اصلی",
  
  
        description:
          "اگر در شرایطی کسی تو رو مجبور کرد دی‌لاک رو باز کنی، رمز پوششی کمک می‌کنه فقط یک فضای بی‌خطر نمایش داده بشه و نوشته‌های اصلی همچنان پنهان بمونن.",
        ...
        points: [
          ...
          "باز کردن با رمز پوششی: اگر مجبور شدی پیوند رو باز کنی، رمز پوششی رو وارد کن تا فقط بخش معمولی نمایش داده بشه.",
  
          "راز اصلی همچنان پنهانه: داده واقعی پشت لایه‌های رمزگذاری باقی می‌مونه و از روی داده رمز شده نمی‌شه وجودش رو اثبات کرد."
        ],
  
  
        tip:
          "نکته: رمز پوششی باید طبیعی به نظر برسه؛ چیزی که در زندگی روزمره خودت هم ممکنه استفاده کنی."
      },
      ...
      emergency: {
        ...
        description:
          "در شرایطی که احتمال دیده شدن ناگهانی دستگاه وجود داره، دی‌لاک ابزارهایی داره که می‌تونن رد داده‌های حساس رو سریع پاک کنن.",
        ...
        points: [
          ...
          "نگهبان تغییر پنجره (Tab Switch): اگر از صفحه بیرون بری یا برگه مرورگر عوض بشه، داده‌های باز شده از حافظه پاک میشن.",
  
          "جلوگیری از چاپ و تصویرگیری: هنگام تلاش برای چاپ یا گرفتن تصویر از صفحه، دی‌لاک می‌تونه اطلاعات حساس رو پاک کنه.",
        ...
        tip:
          "تمرین کن: واکنش سریع در شرایط واقعی مهمه؛ از قبل بدون اگر اتفاقی افتاد، با چه کاری می‌خوای صفحه رو امن کنی."
      },
      perimeter: {
        ...
        description:
          "دی‌لاک می‌تونه از پیوندهای تو در برابر تلاش‌های ناشناس، بررسی‌های خودکار و ورودهای ناخواسته نگهبانی کنه و اگر اتفاق غیرعادی افتاد، بهت خبر بده.",
        ...
        points: [
          ...
          "هشدار مخفی (Canary): یک نشانگر پنهان قرار بده تا اگر کسی بدون اجازه سراغ پیوند رفت، سریع باخبر بشی.",
  
          "ضامن خودکار در صورت عدم پاسخ (Dead Man's Switch): یک بازه زمانی برای اعلام حضور تعیین کن. اگر در زمان مشخص اعلام حضور نکنی، دی‌لاک می‌تونه کاری که از قبل تعیین کردی، مثل پاک کردن داده‌ها، رو انجام بده.",
        ...
        tip:
          "بهترین نتیجه زمانی به دست میاد که چند لایه امنیتی رو کنار هم استفاده کنی؛ هیچ ویژگی به تنهایی جای یک روش کامل امنیتی رو نمی‌گیره."
      }
    }
  }
