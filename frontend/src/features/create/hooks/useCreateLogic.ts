...
export const useCreateLogic = (props: CreateTabProps) => {
  ...
  return {
    ...
    shamirThreshold: vault.shamirThreshold,
    setShamirThreshold: vault.setShamirThreshold,
    shamirShares: vault.shamirShares,
    setShamirShares: vault.setShamirShares,
    ...
    e2eRecipientPubInput: e2e.e2eRecipientPubInput,
    setE2ERecipientPubInput: e2e.setE2ERecipientPubInput,
    e2eMessageText: e2e.e2eMessageText,
    setE2EMessageText: e2e.setE2EMessageText,
    e2eActiveMessages: e2e.e2eActiveMessages,
    setE2EActiveMessages: e2e.setE2EActiveMessages,
    handleRefreshE2EMessages: e2e.handleRefreshE2EMessages,
    handleSendE2EMessage: e2e.handleSendE2EMessage,
    resetE2E: e2e.resetE2E,
